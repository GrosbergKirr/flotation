...
class Tab1:
    ...
    def connectionCreate(self):
        ...
        arrows_data = [
            ((0.085, 0.30), (0.085, 0.26), "arrow_0", [], QtCore.Qt.gray, 3),
            ((0.073, 0.2), (0.822, 0.21), "arrow_1", [(0.073, 0.03), (0.822, 0.03)], QtCore.Qt.gray, 3),
            ((0.098, 0.2), (0.652, 0.21), "arrow_2", [(0.098, 0.045), (0.652, 0.045)], QtCore.Qt.gray, 3),
            ((0.489, 0.76), (0.736, 0.09), "arrow_3", [(0.489, 0.07), (0.736, 0.07)], QtCore.Qt.gray, 3, False),
            ((0.495, 0.753), (0.736, 0.09), "arrow_4", [(0.495, 0.09)], QtCore.Qt.gray, 3, False),
            ((0.736, 0.09), (0.736, 0.22), "arrow_5", [], QtCore.Qt.gray, 3),
            ...
            ((0.63, 0.33), (0.61, 0.39), "arrow_10", [(0.61, 0.33)], QtCore.Qt.gray, 3,False),
            ((0.63, 0.39), (0.61, 0.39), "arrow_11", [], QtCore.Qt.gray, 3, False),
            ((0.61, 0.39), (0.61, 0.44), "arrow_12", [], QtCore.Qt.gray, 3, False),
            ((0.61, 0.44), (0.61, 0.50), "arrow_13", [], QtCore.Qt.gray, 3, False),
            ((0.61, 0.50), (0.63, 0.50), "arrow_14", [], QtCore.Qt.gray, 3, False),
            ((0.61, 0.50), (0.63, 0.555), "arrow_15", [(0.61, 0.555)], QtCore.Qt.gray, 3,False),
            ########
            ((0.651, 0.41), (0.651, 0.47), "arrow_16", [], QtCore.Qt.gray, 3),
            ((0.8205, 0.41), (0.8205, 0.47), "arrow_17", [], QtCore.Qt.gray, 3),
            ((0.61, 0.44), (0.8205, 0.44), "arrow_18", [], QtCore.Qt.gray, 3, False),
            ((0.61, 0.44), (0.56, 0.49), "arrow_19", [(0.56, 0.44)], QtCore.Qt.gray, 3 ),
            # Блок стрелок между 4 и 5 побочными таблицами (по вертикали)
            ((0.80, 0.33), (0.78, 0.39), "arrow_20", [(0.78, 0.33)], QtCore.Qt.gray, 3, False),
            ((0.80, 0.39), (0.78, 0.39), "arrow_21", [], QtCore.Qt.gray, 3, False),
            ((0.78, 0.39), (0.78, 0.44), "arrow_22", [], QtCore.Qt.gray, 3, False),
            ((0.78, 0.44), (0.78, 0.50), "arrow_23", [], QtCore.Qt.gray, 3, False),
            ((0.78, 0.50), (0.80, 0.50), "arrow_24", [], QtCore.Qt.gray, 3, False),
            ((0.78, 0.50), (0.80, 0.555), "arrow_25", [(0.78, 0.555)], QtCore.Qt.gray, 3, False),
            ########
            ((0.651, 0.59), (0.651, 0.64), "arrow_26", [], QtCore.Qt.gray, 3),
            ((0.8205, 0.59), (0.8205, 0.64), "arrow_27", [], QtCore.Qt.gray, 3),
            ((0.78, 0.67), (0.61, 0.64), "arrow_28", [(0.78, 0.62), (0.61, 0.62)], QtCore.Qt.gray, 3, False),
            ((0.61, 0.64), (0.61, 0.67), "arrow_29", [], QtCore.Qt.gray,3, False),
            ((0.63, 0.67), (0.61, 0.67), "arrow_30", [], QtCore.Qt.gray,3, False),
            ((0.63, 0.72), (0.61, 0.67), "arrow_31", [(0.61, 0.72)], QtCore.Qt.gray, 3,False),
            ((0.80, 0.67), (0.78, 0.67), "arrow_32", [], QtCore.Qt.gray, 3, False),
            ((0.80, 0.72), (0.78, 0.67), "arrow_33", [(0.78, 0.72 )], QtCore.Qt.gray, 3, False),
            ((0.61, 0.64), (0.55, 0.72), "arrow_34", [(0.55, 0.64)], QtCore.Qt.gray, 3),
            ((0.31, 0.61), (0.54, 0.72), "arrow_35", [(0.31, 0.66), (0.54, 0.66)], QtCore.Qt.gray, 3),
            ((0.541, 0.511), (0.531, 0.47), "arrow_36", [(0.541, 0.47)], QtCore.Qt.gray, 3, False),
            ((0.531, 0.516), (0.531, 0.47), "arrow_37", [], QtCore.Qt.gray, 3, False),
            ((0.531, 0.47), (0.31, 0.54), "arrow_38", [(0.45,0.47), (0.45, 0.45), (0.31, 0.45)], QtCore.Qt.gray, 3),
            ((0.27, 0.56), (0.20, 0.74), "arrow_35", [(0.18, 0.56), (0.18, 0.74)], QtCore.Qt.gray, 3),
        ]
