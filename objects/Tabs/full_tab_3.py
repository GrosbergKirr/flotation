...
class Tab3:
    ...
    def connectionCreate(self):
        ...
        arrows_data = [
            # Кусок между линия 1 и линия 2 + стерлка
            ((0.215, 0.078), (0.233, 0.078), "arrow_0", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.078), (0.25, 0.078), "arrow_1", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.078), (0.233, 0.11), "arrow_2", [], QtCore.Qt.gray, 5, False),
            ((0.215, 0.11), (0.233, 0.11), "arrow_3", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.11), (0.25, 0.11), "arrow_4", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.11), (0.233, 0.148), "arrow_5", [], QtCore.Qt.gray, 5, False),
            ((0.215, 0.148), (0.233, 0.148), "arrow_6", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.148), (0.25, 0.148), "arrow_7", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.148), (0.233, 0.181), "arrow_8", [], QtCore.Qt.gray, 5, False),
            ((0.215, 0.181), (0.233, 0.181), "arrow_9", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.181), (0.25, 0.181), "arrow_10", [], QtCore.Qt.gray, 5, False),
            ((0.233, 0.181), (0.233, 0.3685), "arrow_11", [], QtCore.Qt.gray, 5),
            # Левые ДМВК и всё что ниже
            ((0.225, 0.375), (0.188, 0.272), "arrow_12", [(0.225, 0.272)], QtCore.Qt.gray, 5),
